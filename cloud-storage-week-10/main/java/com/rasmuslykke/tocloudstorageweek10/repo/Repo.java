package com.rasmuslykke.tocloudstorageweek10.repo;
...
public class Repo {
    ...
    public static void uploadFile(Context context){
        try {
            Log.i("all", "Package name: ");
            InputStream is = context.getAssets().open("car_2,jpg");
            StorageReference ref = storage.getReference("car_2,jpg");
